...
export async function GET(request: NextRequest) {
  try {
    ...
    const totalPlayers = tierStats.reduce(
      (sum: number, stat: any) => sum + (stat.player_count || 0),
      0
    )
    ...
    const teamArchetypes = [
      ...
      },
      {
        ...
        draftStrategy: [
          'Target proven commodities',
          'Avoid reaching for upside',
          'Focus on floor over ceiling',
        ],
      },
      {
        id: 'value',
      ...
      },
      {
        ...
        draftStrategy: [
          'Target 2nd year players',
          'Focus on opportunity changes',
      ...
      },
      {
        ...
        draftStrategy: [
          'Draft elite QB/TE early',
          'Target volume-based skill players',
          'Focus on safe floors',
        ],
      },
      {
        id: 'committee',
        ...
        draftStrategy: [
          'Avoid first 2 rounds of each position',
          'Target consistent veterans',
          'Build deep bench',
        ],
      },
      {
        ...
        draftStrategy: [
          'Target 26-29 age range',
          'Prioritize playoff performers',
      ...
      },
      {
        ...
        draftStrategy: [
          'Fade consensus rankings',
          'Target situation changes',
          'Stream QB/TE aggressively',
        ],
      },
      {
        id: 'analytics',
        ...
        draftStrategy: [
          'Follow model rankings',
          'Target efficiency metrics',
          'Ignore narrative factors',
        ],
      },
    ]
