...
import { Zap, Users2, Trophy, Target, ArrowRight, Music, Play } from 'lucide-react'
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-md sm:max-w-none mx-auto">
              <Link href="/draft-buddy" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="bg-yellow-400 text-slate-900 hover:bg-yellow-300 px-6 sm:px-8 font-mono w-full sm:w-auto min-h-[48px] text-sm sm:text-base"
                >
              ...
              <Link href="/league-buddy" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-slate-900 px-6 sm:px-8 font-mono w-full sm:w-auto min-h-[48px] text-sm sm:text-base"
                >
            ...
            <div className="space-y-3 sm:space-y-4 p-4 sm:p-6 bg-slate-800/30 rounded-lg border border-slate-700/50 hover:border-yellow-400/30 transition-all">
              ...
              <Link href="/draft-buddy">
                <Button
                  variant="ghost"
                  size="sm"
                  className="text-yellow-400 hover:text-yellow-300 font-mono p-0 h-auto hover:bg-transparent min-h-[44px] flex items-center"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 max-w-2xl mx-auto">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-base sm:text-lg font-semibold text-white mb-1 font-mono">
                  TikTok
                </h3>
