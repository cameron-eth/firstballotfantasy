        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-12">
            ...
            <p className="text-slate-400 mb-6">
              No league ID found. Please enter your Sleeper league ID:
            </p>
              ...
              <div className="flex justify-center items-center space-x-2 sm:space-x-4 md:space-x-6 text-sm overflow-x-auto">
                ...
                <div className="text-center flex-shrink-0">
                  <div className="text-xl sm:text-2xl font-bold text-purple-400">
                    {Math.round(
                      tradeAnalysis.reduce((sum, trade) => sum + trade.totalTradeValue, 0)
                    )}
                  </div>
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-yellow-400">
                    {traderStats.length > 0
                      ? Math.round(
                          traderStats
                            .slice(0, 3)
                            .reduce((sum, trader) => sum + trader.marketShareByValue, 0)
                        )
                      : 0}
                    %
                  </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-green-400/70">
                    {tradeAnalysis.length > 0
                      ? '+' + Math.round((tradeAnalysis.length / 12) * 100) + '% avg'
                      : 'No data'}
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <div className="text-2xl font-bold text-blue-400">
                    {tradeAnalysis.reduce(
                      (sum, trade) =>
                        sum +
                        trade.teams.reduce(
                          (s, team) => s + team.playersReceived.length + team.playersSent.length,
                          0
                        ),
                      0
                    )}
                      ...
                      ? Math.round(
                          tradeAnalysis.reduce(
                            (sum, trade) =>
                              ...
                              trade.teams.reduce(
                                (s, team) =>
                                  s + team.playersReceived.length + team.playersSent.length,
                                0
                              ),
                            0
                          ) / tradeAnalysis.length
                    ...
                    {tradedPicks.length +
                      tradeAnalysis.reduce(
                        (sum, trade) =>
                          sum +
                          trade.teams.reduce(
                            (s, team) => s + team.picksReceived.length + team.picksSent.length,
                            0
                          ),
                        0
                      )}
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-orange-400/70">Top 3 traders control</div>
                </div>
              </div>
            </CardContent>
          </Card>
                      ...
                      >
                          ...
                          <div className="space-y-3">
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <div className="flex items-center space-x-2">
                                    {isTopTrader && (
                                      <Badge
                                        variant="outline"
                                        className="bg-yellow-400/10 text-yellow-400 border-yellow-400/30 text-xs"
                                      >
                                        Top
                                      </Badge>
                                    )}
                                    <Badge
                                      variant="outline"
                                      className={`text-sm px-2 py-1 ${GRADE_COLORS[trader.grade as keyof typeof GRADE_COLORS]}`}
                                    >
                                      {trader.grade}
                                    </Badge>
                                  </div>
                            ...
                            <div className="grid grid-cols-3 gap-4 pt-2 border-t border-slate-600/30">
                              ...
                              <div className="text-center">
                                ...
                                <div
                                  className={`text-lg font-bold ${trader.avgValuePerTrade >= 0 ? 'text-green-400' : 'text-red-400'}`}
                                >
                              ...
                              <div className="text-center">
                                ...
                                <div
                                  className={`text-lg font-bold ${trader.totalValueGained >= 0 ? 'text-green-400' : 'text-red-400'}`}
                                >
                            ...
                            <div className="flex items-center justify-between pt-2 border-t border-slate-600/30">
                              <div className="flex items-center space-x-2">
                                <Badge
                                  variant="outline"
                                  className="text-xs bg-purple-400/10 text-purple-400 border-purple-400/30"
                                >
                        ...
                        <div className="hidden sm:flex sm:items-center justify-between">
                          ...
                          <div className="flex items-center space-x-6">
                            ...
                            <Badge
                              variant="outline"
                              className={`text-sm px-3 py-1 ${GRADE_COLORS[trader.grade as keyof typeof GRADE_COLORS]}`}
                            >
                              {trader.grade}
                            </Badge>
                          </div>
                ...
                <div className="space-y-6">
                  {tradeAnalysis.map((trade) => (
                    <div
                      ...
                      className="p-6 bg-slate-700 border border-slate-600 rounded-lg"
                    >
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-slate-200 mb-4">
                      League Grade Distribution
                    </h3>
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-10 gap-3">
                      {['A+', 'A', 'B+', 'B', 'B-', 'C+', 'C', 'C-', 'D', 'F'].map((grade) => {
                        const count = traderStats.filter((trader) => trader.grade === grade).length
                        const percentage =
                          traderStats.length > 0 ? (count / traderStats.length) * 100 : 0
                        return (
                          <div
                            key={grade}
                            className="text-center p-3 bg-slate-700/50 rounded-lg border border-slate-600/50"
                          >
                            <Badge
                              variant="outline"
                              className={`mb-2 ${GRADE_COLORS[grade as keyof typeof GRADE_COLORS]}`}
                            >
                              {grade}
                            </Badge>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      {(() => {
                        ...
                        const eligibleTraders = traderStats.filter(
                          (trader) => trader.totalTrades >= 2
                        )
                          ...
                          return (
                            <div className="p-3 bg-slate-700/50 rounded-lg border border-slate-600/50 text-center">
                              <div className="text-slate-400">
                                No eligible traders (minimum 2 trades required)
                              </div>
                            </div>
                          )
                        }
                        ...
                        const maxTotalValue = Math.max(
                          ...eligibleTraders.map((t) => t.totalValueGained)
                        )
                        const maxAvgValue = Math.max(
                          ...eligibleTraders.map((t) => t.avgValuePerTrade)
                        )

                        const scoredTraders = eligibleTraders
                          .map((trader) => ({
                            ...trader,
                            compositeScore:
                          ...
                          <>
                            ...
                            <div className="flex items-center justify-between p-3 bg-gradient-to-r from-yellow-400/5 to-green-400/5 rounded-lg border border-yellow-400/20">
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  ...
                                  <div className="text-xs text-yellow-400">
                                    {formatValue(bestTrader.avgValuePerTrade)} avg •{' '}
                                    {formatValue(bestTrader.totalValueGained)} total
                                  </div>
                                </div>
                              </div>
                              <div className="text-right">
                                ...
                                <Badge
                                  variant="outline"
                                  className={`text-xs ${GRADE_COLORS[bestTrader.grade as keyof typeof GRADE_COLORS]}`}
                                >
                                  {bestTrader.grade}
                                </Badge>
                              </div>
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="flex items-center justify-between p-3 bg-slate-700/50 rounded-lg border border-slate-600/50">
                            <div className="flex items-center space-x-3">
                              <div className="w-8 h-8 bg-red-400 rounded-full flex items-center justify-center text-white font-bold text-sm">
                                ⚠️
                              </div>
                              <div>
                                <div className="text-slate-100 font-semibold">
                                ...
                                <div className="text-xs text-red-400">
                                  {formatValue(worstTrader.avgValuePerTrade)} avg •{' '}
                                  {formatValue(worstTrader.totalValueGained)} total
                                </div>
                              </div>
                            </div>
                            <div className="text-right">
                              ...
                              <Badge
                                variant="outline"
                                className={`text-xs ${GRADE_COLORS[worstTrader.grade as keyof typeof GRADE_COLORS]}`}
                              >
                                {worstTrader.grade}
                              </Badge>
                            </div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="p-3 bg-slate-700/50 rounded-lg border border-slate-600/50 text-center">
                          <div className="text-xl font-bold text-blue-400">
                            {tradeAnalysis.length > 0
                              ? Math.round(
                                  tradeAnalysis.reduce(
                                    (sum, trade) => sum + trade.totalTradeValue,
                                    0
                                  ) / tradeAnalysis.length
                                )
                              : 0}
                        ...
                        <div className="p-3 bg-slate-700/50 rounded-lg border border-slate-600/50 text-center">
                          <div className="text-xl font-bold text-purple-400">
                            {traderStats.length > 0
                              ? traderStats.filter((t) => t.totalValueGained > 0).length
                              : 0}
                          </div>
                ...
                <CardContent>
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {getValuationSystemDescription().draftPickValues.values.map(
                          (value, index) => (
                            <div
                              key={index}
                              className="flex items-center justify-between p-3 bg-slate-700/50 rounded-lg border border-slate-600/50"
                      ...
                      <div className="p-4 bg-slate-700/30 rounded-lg border border-slate-600/30">
                        <div className="space-y-2 text-sm text-slate-300">
                          <div className="flex items-start space-x-2">
                            ...
                            <span>
                              <strong className="text-yellow-400">Total Value Gained:</strong> Sum
                              of all net value from your trades
                            </span>
                          </div>
                          <div className="flex items-start space-x-2">
                            <div className="w-2 h-2 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                            <span>
                              <strong className="text-blue-400">Grade Scale:</strong> A+ (50+), A
                              (30+), B (0+), C (-30+), D (-50+), F (below -50)
                            </span>
                          </div>
                          <div className="flex items-start space-x-2">
                            <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                            <span>
                              <strong className="text-green-400">Positive Values:</strong> You
                              gained more value than you gave up
                            </span>
                          </div>
                          <div className="flex items-start space-x-2">
                            <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                            <span>
                              <strong className="text-red-400">Negative Values:</strong> You gave up
                              more value than you received
                            </span>
                          </div>
                        </div>
                      </div>
