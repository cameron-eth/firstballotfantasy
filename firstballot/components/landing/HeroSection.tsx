...
import { Zap, Users2, Trophy, ArrowRight, Eye, ShoppingCart, ShieldCheck, Activity, Target, Sparkles } from 'lucide-react'
        ...
        <div className="flex flex-col items-center justify-center gap-4 mb-12 animate-on-scroll">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[9px] font-mono text-slate-500 uppercase tracking-widest">Diamond Tier Scouts Online</span>
            </div>
          </div>
        </div>

        {/* Main Heading - Fantasy Focused */}
        <div className="text-center mb-16 space-y-6 animate-on-scroll" style={{ animationDelay: '0.1s' }}>
          <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black text-white tracking-tighter font-mono leading-[0.85] uppercase">
            DYNASTY
            <br />
            <span className="text-yellow-400 drop-shadow-[0_0_30px_rgba(250,204,21,0.2)]">DOMINANCE</span>
          </h1>
        ...
        >
          ...
          <Link href="/league-buddy" className="group">
            <div className="h-full bg-slate-950/40 backdrop-blur-sm border border-white/5 rounded-2xl p-6 transition-all duration-500 hover:border-yellow-400/30 hover:bg-slate-900/60 flex flex-col items-center text-center">
              ...
              <h3 className="text-sm font-black text-white font-mono uppercase tracking-widest mb-2">League Buddy</h3>
              <p className="text-[10px] text-slate-500 font-mono uppercase leading-relaxed mb-6">Analyze your league rosters and identify trade targets.</p>
          ...
          <Link href="/scouting-portal" className="group">
            <div className="h-full bg-slate-950/40 backdrop-blur-sm border border-white/5 rounded-2xl p-6 transition-all duration-500 hover:border-blue-400/30 hover:bg-slate-900/60 flex flex-col items-center text-center relative overflow-hidden">
              ...
              <h3 className="text-sm font-black text-white font-mono uppercase tracking-widest mb-2 text-blue-400">Scouting Portal</h3>
              <p className="text-[10px] text-slate-500 font-mono uppercase leading-relaxed mb-6">Scout 2026 prospects with advanced data and comps.</p>
          ...
          <Link href="/trade-calculator" className="group">
            <div className="h-full bg-slate-950/40 backdrop-blur-sm border border-white/5 rounded-2xl p-6 transition-all duration-500 hover:border-emerald-400/30 hover:bg-slate-900/60 flex flex-col items-center text-center">
              ...
              <h3 className="text-sm font-black text-white font-mono uppercase tracking-widest mb-2">Trade Calc</h3>
              <p className="text-[10px] text-slate-500 font-mono uppercase leading-relaxed mb-6">Evaluate dynasty trades using our ML value index.</p>
        ...
        <div className="animate-on-scroll" style={{ animationDelay: '0.3s' }}>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black font-mono text-slate-700 uppercase tracking-[0.3em]">Featured Prospect Report</span>
            </div>
            <div className="h-px flex-1 bg-white/5" />
          </div>
