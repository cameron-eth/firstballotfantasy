  ...
  const tacticalModules = [
    {
      ...
      icon: Search,
      color: 'text-blue-400',
      desc: 'Detailed tape analysis and traits.',
    },
    {
      name: 'NFL Comps',
      icon: Crosshair,
      color: 'text-emerald-400',
      desc: 'Predictive pro player comparisons.',
    },
    {
      name: 'Draft Value',
      icon: BarChart3,
      color: 'text-amber-400',
      desc: 'Market-beating rookie projections.',
    },
  ]
    ...
    <section className="max-w-7xl mx-auto py-24 px-6 animate-on-scroll">
      <div className="relative overflow-hidden bg-slate-950/40 backdrop-blur-xl border border-white/5 rounded-[2.5rem] p-8 md:p-16">
        ...
        <div className="absolute top-8 left-8 flex items-center gap-2 opacity-20">
          ...
          <span className="text-[10px] font-mono text-slate-500 uppercase tracking-[0.5em]">
            Diamond Tier Scouting Active
          </span>
        </div>
          ...
          <div className="space-y-10">
            <div className="space-y-4">
              ...
              <p className="text-slate-400 text-sm md:text-base font-mono uppercase tracking-wide leading-relaxed max-w-xl opacity-80">
                Our scouting engine identifies elite outliers before the market catches up. Build
                your dynasty around the next generation of superstars.
              </p>
            </div>
              ...
              {tacticalModules.map((module) => (
                <div key={module.name} className="group relative">
                  ...
                  <div className="relative p-5 bg-slate-900/40 border border-white/5 rounded-xl hover:border-blue-400/30 transition-all">
                    ...
                    <p className="text-[9px] text-slate-500 font-mono uppercase leading-tight">
                      {module.desc}
                    </p>
                  </div>
                </div>
            ...
            <Link href="/scouting-portal" className="inline-block group">
              <div className="flex items-center gap-6">
                <Button
                  size="lg"
                  className="bg-blue-500 hover:bg-blue-400 text-white font-black font-mono h-14 px-10 shadow-[0_0_40px_rgba(59,130,246,0.2)] rounded-xl uppercase tracking-widest"
                >
                  Explore Prospects
                  <ArrowRight className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" />
                </Button>
                <div className="hidden sm:flex flex-col">
                  <span className="text-[10px] font-black font-mono text-emerald-500 uppercase">
                    Live: 2026 Prospects
                  </span>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 bg-white/5 border border-white/5 rounded-2xl">
                      <span className="text-[9px] font-black font-mono text-slate-500 uppercase mb-2 block tracking-widest">
                        Hit Rate
                      </span>
...
function Badge({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
    <span
      className={`px-2 py-0.5 rounded text-[10px] font-black font-mono border uppercase tracking-wider ${className}`}
    >
      {children}
    </span>
  )
