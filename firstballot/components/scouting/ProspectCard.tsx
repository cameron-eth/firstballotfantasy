...
export function DraftBoardItem({
  ...
  return (
    <div
      ...
      className="group relative bg-card rounded-xl overflow-hidden border border-border hover:border-primary/50 transition-colors duration-300 p-4"
    >
      <div className="flex items-start justify-between gap-3">
        ...
        {index + 1}
          ...
          <div className="min-w-0">
            <div className="font-mono text-[22px] font-bold text-foreground truncate leading-tight">
              {player.name}
            </div>
        ...
        <div className="flex items-center gap-2">
          <span
            className={cn(
              'px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider rounded border',
              tierColor.bg,
              tierColor.text,
              tierColor.border
            )}
...
export function AddProspectItem({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'w-full text-left group relative bg-card rounded-xl overflow-hidden border border-border p-4 transition-colors duration-300',
        isOnBoard ? 'opacity-50 cursor-not-allowed' : 'hover:border-primary/50 active:scale-[0.99]'
      )}
    >
      <div className="flex items-center justify-between gap-3">
        ...
        >
          {isOnBoard ? 'ON BOARD' : player.tier}
        </span>
      </div>
    </button>
  )
