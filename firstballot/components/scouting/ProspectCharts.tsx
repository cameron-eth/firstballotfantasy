      ...
      >
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-mono text-gray-500 uppercase">Distribution</span>
          </div>
        </CardHeader>
        <CardContent>
            ...
            {Object.entries(positionDistribution)
              ...
              .map(([position, count], i) => (
                <div key={position} className="flex items-center gap-3">
                  <div className="text-sm text-gray-400 font-mono w-8">{position}</div>
                  <div className="flex-1 h-6 bg-slate-700 rounded-full overflow-hidden relative">
                    <div
                      className={`h-full ${positionColors[position] || 'bg-slate-500'} rounded-full origin-left flex items-center justify-end pr-2`}
                      style={{
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-mono text-gray-500 uppercase">Tier Breakdown</span>
          </div>
        </CardHeader>
        <CardContent>
          <div className="text-3xl font-bold text-white font-mono mb-4">{prospects.length}</div>
            ...
            {Object.entries(tierDistribution)
              ...
              .map(([tier, count], i) => (
                <div key={tier} className="flex items-center gap-3">
                  <div className="text-sm text-gray-400 font-mono w-20 truncate">{tier}</div>
                  <div className="flex-1 h-6 bg-slate-700 rounded-full overflow-hidden relative">
                    <div
                      className={`h-full ${tierColors[tier] || 'bg-gray-400'} rounded-full origin-left flex items-center justify-end pr-2`}
                      style={{
